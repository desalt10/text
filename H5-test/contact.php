...
<html>
	<head>
		...
		<link rel="stylesheet" href="css/sassConfig.css" />
		<link rel="stylesheet" href="css/common.css" />
		<link rel="stylesheet" href="css/normalize.css" />
		<link rel="stylesheet" href="font/font-awesome-4.7.0/css/font-awesome.min.css">
		<link rel="stylesheet" href="font/iconfont/iconfont.css">
		<link rel="stylesheet" href="css/main.css" />
		 <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=zu9IEUpGBcwBTOl027FZmRWYIm37HG1G"></script>
	</head>
	<body>
		<!-- 头部 start-->
			 ...
			 <div class="baidu-map" id="map"></div>
				<div class="content-wrap">
					 <div class="info">
						 ...
						 <span class="">集团总部招商热线：</span>
						 <a class="telphone" herf="tel:0755-56566573">0755-56566573</a>
						<p>
							 <strong>地址</strong><br/>
			...
			<div class="jobs-list" id="jobsList">
				<section>
					...
					<div class="mark" data-type="mark"></div>
						...
						<span>工作地点:<strong>财务</strong></span>
					</header>
					<div class="content">
						<div class="info">
							<p>岗位职责：<br/>
	...
	职能类别：会计 财务助理/文员<br/>
				...
				<section>
					...
					<div class="content">
						...
						<a href="mailto:liangy@langlangdental.com" class="button">立即申请</a>
						<div class="info">
							<span>邮箱：<a>liangy@langlangdental</a></span>
							<span>手机：<a>86-6582-2617</a>（梁小姐）</span>
							<span>座机：<a>0755-86566573转6019l</a></span>
						</div>
					</div>
				</section>
			</div>
